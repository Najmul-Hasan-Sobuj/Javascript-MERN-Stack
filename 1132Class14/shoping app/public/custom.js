...
p_form.addEventListener('submit', function(e) {
    ...
    let productArr;
    if (dataget('product')) {
        productArr = dataget('product');
    }else{
        productArr = [];
    }
    productArr.push({p_name: p_name, p_price: p_price,p_s_price: p_s_price,p_img: p_img,});
    dataSet('product', productArr);
    allProducts();
...
function allProducts() {
    let allProducts = dataget('product');
    let data = '';
